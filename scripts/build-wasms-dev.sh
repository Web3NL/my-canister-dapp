...
mkdir -p wasm/dev
cp examples/my-hello-world/target/wasm32-unknown-unknown/release/my-hello-world.wasm wasm/dev/my-hello-world-dev.wasm
cp examples/my-hello-world/target/wasm32-unknown-unknown/release/my-hello-world.wasm.gz wasm/dev/my-hello-world-dev.wasm.gz
