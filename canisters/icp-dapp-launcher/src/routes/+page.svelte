...
<div class="page">
  <div class="gradient-orb orb-top"></div>
  <div class="gradient-orb orb-bottom"></div>
  ...
  <main>
    <section class="hero">
      ...
      <p class="tagline">Fully owned decentralized apps</p>

      <div class="cta-buttons">
        <a
          href="https://github.com/Web3NL/my-canister-dapp"
